...
System.out.println("#,Browser,Page,Field,isPresent,Value");
		  ...
		  report.write("01,Chrome,index.php,First Name," + isElementPresent(By.id(p.getProperty("fname_id"))) + "," + p.getProperty("fname_value")); 								report.write(ls);
System.out.println("01,Chrome,index.php,First Name," + isElementPresent(By.id(p.getProperty("fname_id"))) + "," + p.getProperty("fname_value"));

		  setValue(By.id(p.getProperty("fname_id")),"fname_value");

        report.write("02,Chrome,index.php,Last Name," + isElementPresent(By.id(p.getProperty("lname_id"))) + "," + p.getProperty("lname_value")); 									report.write(ls);
System.out.println("02,Chrome,index.php,Last Name," + isElementPresent(By.id(p.getProperty("lname_id"))) + "," + p.getProperty("lname_value"));

		  	  setValue(By.id(p.getProperty("lname_id")),"lname_value");

		  report.write("03,Chrome,index.php,Email," + isElementPresent(By.id(p.getProperty("email_id"))) + "," + p.getProperty("email_value"));         									 report.write(ls);
System.out.println("03,Chrome,index.php,Email," + isElementPresent(By.id(p.getProperty("email_id"))) + "," + p.getProperty("email_value"));

		  setValue(By.id(p.getProperty("email_id")),"email_value");

		  report.write("04,Chrome,index.php,Phone," + isElementPresent(By.id(p.getProperty("phone_id"))) + "," + p.getProperty("phone_value"));                                          report.write(ls);
System.out.println("04,Chrome,index.php,Phone," + isElementPresent(By.id(p.getProperty("phone_id"))) + "," + p.getProperty("phone_value"));

		  setValue(By.id(p.getProperty("phone_id")),"phone_value");
		  driver.findElement(By.id(p.getProperty("submit_id"))).click();

		  report.write("05,Chrome,confirmation.php,First Name," + isElementPresent(By.id(p.getProperty("fname_id"))) + "," + getValue(By.id(p.getProperty("fname_id")))); report.write(ls);
System.out.println("05,Chrome,confirmation.php,First Name," + isElementPresent(By.id(p.getProperty("fname_id"))) + "," + getValue(By.id(p.getProperty("fname_id"))));

		  report.write("06,Chrome,confirmation.php,Last Name," + isElementPresent(By.id(p.getProperty("lname_id"))) + "," + getValue(By.id(p.getProperty("lname_id")))); report.write(ls);
System.out.println("06,Chrome,confirmation.php,Last Name," + isElementPresent(By.id(p.getProperty("lname_id"))) + "," + getValue(By.id(p.getProperty("lname_id"))));

		  report.write("07,Chrome,confirmation.php,Email," + isElementPresent(By.id(p.getProperty("email_id"))) + "," + getValue(By.id(p.getProperty("email_id"))));           report.write(ls);
System.out.println("07,Chrome,confirmation.php,Email," + isElementPresent(By.id(p.getProperty("email_id"))) + "," + getValue(By.id(p.getProperty("email_id"))));

		  report.write("08,Chrome,confirmation.php,Phone," + isElementPresent(By.id(p.getProperty("phone_id"))) + "," + getValue(By.id(p.getProperty("phone_id"))));         report.write(ls);
System.out.println("08,Chrome,confirmation.php,Phone," + isElementPresent(By.id(p.getProperty("phone_id"))) + "," + getValue(By.id(p.getProperty("phone_id"))));
